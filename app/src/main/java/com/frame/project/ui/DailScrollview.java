...
//	  }
//	  public DailScrollview(Context context, AttributeSet attrs, int defStyle) {
...
//	        	int scrollYhandler = DailScrollview.this.getScrollY();  
//	            //此时的距离和记录下的距离不相等，在隔5毫秒给handler发送消息  
//	            if(lastScrollY != scrollYhandler){  
//	                lastScrollY = scrollYhandler;  
//	                handler.sendMessageDelayed(handler.obtainMessage(), 5);    
//	            }  
//	            if(onScrollListener != null){  
//	                onScrollListener.onScroll(scrollYhandler);  
//	            }  
//	        };  
//	  
//	    }; 
...
//	       
//	        if(scrollY != 0 &&scrollY>0&& null != onScrollToBottom){  
//
...
//	        public void onScrollTopListener(boolean isBottom);  
//	    } 
//	    
//		public void setOnScrollToTopListener(OnScrollToTopListener listener) {
//			this.onScrollToTop = listener;
//		}
//		///////////////////////////////////////////这是两个不同的功能/////////////////////////////////////////////////////////////////////////////
//		
//		//移动因子, 是一个百分比, 比如手指移动了100px, 那么View就只移动50px
