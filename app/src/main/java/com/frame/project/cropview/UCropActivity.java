...
public class UCropActivity extends AppCompatActivity {
    ...
    private ImageView crop_iv_back;
    private ImageView crop_iv_done;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cropview_cropactivity);
    ...
    private void initTitle(){
        crop_iv_back = (ImageView) findViewById(R.id.crop_iv_back);
        crop_iv_done = (ImageView) findViewById(R.id.crop_iv_done);
        crop_iv_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UCropActivity.this.finish();
            }
        });
        crop_iv_done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                cropAndSaveImage();
            }
