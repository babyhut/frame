package com.frame.project.cropview;
...
import com.frame.project.cropview.callback.BitmapCropCallback;
import com.frame.project.cropview.modle.AspectRatio;
import com.frame.project.cropview.modle.UCrop;
import com.frame.project.cropview.util.SelectedStateListDrawable;
import com.frame.project.cropview.view.CropImageView;
import com.frame.project.cropview.view.GestureCropImageView;
import com.frame.project.cropview.view.OverlayView;
import com.frame.project.cropview.view.TransformImageView;
import com.frame.project.cropview.view.UCropView;
import com.frame.project.cropview.widget.AspectRatioTextView;
import com.frame.project.cropview.widget.HorizontalProgressWheelView;
 ...
 * 创建人: xuyanyun
 * 联系方式:
 * 创建时间: 2017/7/27 15:51
 * 页面名称:
 */

public class CropActivity extends AbstractActivity {
    @BindView(id = R.id.crop_iv_back,click = true)
    private ImageView crop_iv_back;//标题栏返回键
    @BindView(id = R.id.crop_iv_done,click = true)
    private ImageView crop_iv_done;//标题栏确定键
    @BindView(id =R.id.image_view_logo)
    private ImageView image_view_logo ;
    @BindView(id = R.id.ucrop)
    private UCropView mUCropView;



    public  final int DEFAULT_COMPRESS_QUALITY = 90;
    public  final Bitmap.CompressFormat DEFAULT_COMPRESS_FORMAT = Bitmap.CompressFormat.JPEG;
    ...
    protected int getLayoutId() {
        return R.layout.activity_cropview_cropactivity;
    }
    ...
    private void setupViews(@NonNull Intent intent) {
        ...
        if (mShowBottomControls) {
            ...
            View.inflate(this, R.layout.view_controls, photoBox);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        if (aspectRatioList == null || aspectRatioList.isEmpty()) {
            ...
            aspectRatioList.add(new AspectRatio(getString(R.string.app_name).toUpperCase(),
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            wrapperAspectRatio = (FrameLayout) getLayoutInflater().inflate(R.layout.view_aspect_ratio, null);
